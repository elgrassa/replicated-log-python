...
class TestErrorHandling:
    ...
    # Commented out: This test requires more than 2 secondaries to work properly
    # With exactly 2 secondaries, stopping one to test failure scenarios is too fragile
